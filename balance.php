...
if ((!isset($_SESSION['balance_period']))) {
  ...
  $incomeAllQuery = $db->query("SELECT incomes.user_id,incomes.amount,
              ...
              WHERE incomes.user_id ='$logged_id' AND month(date_of_income)=month(now())ORDER BY date_of_income DESC");
  $incomesAllCat = $incomeAllQuery->fetchAll();

  $incomeCatQuery = $db->query("SELECT incomes.user_id,incomes.amount,
              incomes_category_assigned_to_users.name, 
              incomes.amount,
              SUM(incomes.amount),
              incomes.date_of_income,
              ...
              FROM incomes 
              INNER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id 
              WHERE incomes.user_id ='$logged_id' AND month(date_of_income)=month(now())  GROUP BY income_category_assigned_to_user_id");
  ...
  $expenseAllQuery = $db->query("SELECT expenses.user_id,
      ...
      WHERE expenses.user_id ='$logged_id'AND month(date_of_expense)=month(now()) ORDER BY date_of_expense DESC");
  ...
  $expenseQuery = $db->query("SELECT expenses.user_id,
              ...
              WHERE expenses.user_id ='$logged_id'AND month(date_of_expense)=month(now()) GROUP BY expense_category_assigned_to_user_id");
  $expenses = $expenseQuery->fetchAll();

  

  $IncomesSumQuery = $db->query("SELECT SUM(amount) FROM incomes WHERE user_id='$logged_id' && month(date_of_income)=month(now())  ");
  $IncomesSum = $IncomesSumQuery->fetchAll();

  $ExpensesSumQuery = $db->query("SELECT SUM(amount) FROM expenses WHERE user_id='$logged_id' && month(date_of_expense)=month(now())  ");
...
$currentMonth = $_POST['balance_period'];
...
if (isset($_POST['balance_period'])) {
  ...
  switch ($currentMonth) {
    case 'current_month':
      ...
      /////////
      $incomeCatQuery = $db->query("SELECT incomes.user_id,SUM(amount),
              incomes_category_assigned_to_users.name, 
              SUM(incomes.amount),
              incomes.date_of_income,
              incomes.income_comment
    ...
    case 'last_month':
      ...
      $incomeAllQuery = $db->query("SELECT incomes.user_id,incomes.amount,
              ...
              FROM incomes 
              INNER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id 
              WHERE incomes.user_id ='$logged_id' AND month(date_of_income)=month(now()) -1 ORDER BY date_of_income DESC");
      $incomesAllCat = $incomeAllQuery->fetchAll();
      ...
      $incomeCatQuery = $db->query("SELECT incomes.user_id,SUM(amount),
              ...
              FROM incomes 
              INNER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id 
              WHERE incomes.user_id ='$logged_id' AND month(date_of_income)=month(now())-1 GROUP BY income_category_assigned_to_user_id");
      $incomesCat = $incomeCatQuery->fetchAll();
      ...
      WHERE expenses.user_id ='$logged_id'AND month(date_of_expense)=month(now())-1 ORDER BY date_of_expense DESC");
      $expensesAll = $expenseAllQuery->fetchAll();
      ...
      $expenseQuery = $db->query("SELECT expenses.user_id,
              ...
              WHERE expenses.user_id ='$logged_id'AND month(date_of_expense)=month(now())-1 GROUP BY expense_category_assigned_to_user_id");
      $expenses = $expenseQuery->fetchAll();

      $IncomesSumQuery = $db->query("SELECT SUM(amount) FROM incomes WHERE user_id='$logged_id' && month(date_of_income)=month(now())-1  ");
      $IncomesSum = $IncomesSumQuery->fetchAll();

      $ExpensesSumQuery = $db->query("SELECT SUM(amount) FROM expenses WHERE user_id='$logged_id' && month(date_of_expense)=month(now())-1  ");
      $ExpensesSum = $ExpensesSumQuery->fetchAll();
    ...
    case 'current_year':
      ...
      $incomeAllQuery = $db->query("SELECT incomes.user_id,incomes.amount,
              ...
              FROM incomes 
              INNER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id 
              WHERE incomes.user_id ='$logged_id' AND year(date_of_income)=year(now())ORDER BY date_of_income DESC");
      $incomesAllCat = $incomeAllQuery->fetchAll();
      ...
      $incomeCatQuery = $db->query("SELECT incomes.user_id,
              ...
              FROM incomes 
              INNER JOIN incomes_category_assigned_to_users ON incomes.income_category_assigned_to_user_id = incomes_category_assigned_to_users.id 
              WHERE incomes.user_id ='$logged_id' AND year(date_of_income)=year(now()) GROUP BY income_category_assigned_to_user_id");
      $incomesCat = $incomeCatQuery->fetchAll();
      ...
      INNER JOIN payment_methods_assigned_to_users ON
      expenses.payment_method_assigned_to_user_id =payment_methods_assigned_to_users.id
      WHERE expenses.user_id ='$logged_id'AND year(date_of_expense)=year(now()) ORDER BY date_of_expense DESC");
      ...
      $expenseQuery = $db->query("SELECT expenses.user_id,
              ...
              WHERE expenses.user_id ='$logged_id'AND year(date_of_expense)=year(now()) GROUP BY expense_category_assigned_to_user_id");
      $expenses = $expenseQuery->fetchAll();

      $IncomesSumQuery = $db->query("SELECT SUM(amount) FROM incomes WHERE user_id='$logged_id' && year(date_of_income)=year(now())  ");
      $IncomesSum = $IncomesSumQuery->fetchAll();

      $ExpensesSumQuery = $db->query("SELECT SUM(amount) FROM expenses WHERE user_id='$logged_id' && year(date_of_expense)=year(now())  ");
      $ExpensesSum = $ExpensesSumQuery->fetchAll();
    ...
    <div class="container ">
      ...
      <div class="dropdown ml-auto px-5 mt-4">
        ...
        <div class="dropdown-menu col-lg-2 col-md-3 col-sm-4 col-5" aria-labelledby="dropdownMenu2">
          <form action="balance.php" method="post" name="balanceperiod">
            ...
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#exampleModal" name="" value="select_period">
              Niestandardowy
            </button>
          </form>
