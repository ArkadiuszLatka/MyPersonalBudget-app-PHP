            ...
            <div class="col">
                <div class="jumbotron">
                    <div class="container ">
                        ...
                        <h1 class="Site-title display-3 ">Aplikacja <i class="fas fa-piggy-bank text-success mt-5"></i> MyPerso<span class="text-success">nal</span>Budget</h1>

                        <hr class="my-4 ">
                        <p class="text-justify">to proste i bardzo skuteczne narzędzie, które pomoże Ci jeszcze lepiej wykorzystać
                            zarabiane przez Ciebie pieniądze dzięki czemu znacznie szybciej zrealizujesz swoje cele i marzenia.</p>
                    </div>
                </div>
            </div>
